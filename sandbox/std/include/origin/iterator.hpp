...
namespace origin
{
  ...
  template <typename I>
    std::ptrdiff_t iterative_distance(I first, I last)
    {
      std::ptrdiff_t n = 0;
      while (first != last) {
        ++n;
  ...
  // FIXME: I feel like this specialization should be defined for any measurable
  // field. The distance between integers and reals should be well-defined.
  template <typename I>
    auto distance(I first, I last)
  ...
  template<typename I1, typename I2>
    constexpr bool Can_memcmp()
    {
      ...
      return Cxx_pointer<B1>() && Memory_comparable<Value_type<B1>>()
          && Cxx_pointer<B2>() && Memory_comparable<Value_type<B2>>()
