...
#include <list>
#include <map>
#include <queue>//added by Brian
#include <deque>//added by Brian
#include <stack>//added by Brian
#include <set>
#include <unordered_map>//added by Brian

//#include<unordered_set>
/*
#if !defined BOOST_NO_HASH
#  ifdef BOOST_HAS_TR1_UNORDERED_SET
#    include BOOST_HAS_TR1_UNORDERED_SET
#  else
...
// adaptor specialization for queue.
// for queue
#if !defined BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION
  template <class T, class Alloc> 
  struct container_traits< std::queue<T,Alloc> > {
    typedef enqueueable_adaptor_tag category;
...
/*  template <class Key, class Eq, class Hash, class Alloc> 
  struct container_traits< BOOST_STD_EXTENSION_NAMESPACE::unordered_set<Key,Eq,Hash,Alloc> > {
    typedef set_tag category;
  ...
  */
  ...
  struct container_traits< std::unordered_map<Key,T,Eq,Hash,Alloc> > {
    ...
    /*
  template <class Key, class Eq, class Hash, class Alloc>
  set_tag container_category(const BOOST_STD_EXTENSION_NAMESPACE::unordered_set<Key,Eq,Hash,Alloc>&)
  { return set_tag(); }
    */
...
/*
  template <class Key, class Eq, class Hash, class Alloc>
  stable_tag iterator_stability(const BOOST_STD_EXTENSION_NAMESPACE::unordered_set<Key,Eq,Hash,Alloc>&)
  { return stable_tag(); }
*/
  template <class Key, class T, class Eq, class Hash, class Alloc>
  stable_tag iterator_stability(const std::unordered_map<Key,T,Eq,Hash,Alloc>&)
  { return stable_tag(); }
#endif
  ...
  template <class AssociativeContainer, class T>
  std::pair<typename AssociativeContainer::iterator, bool>
  push_dispatch(AssociativeContainer& c, T&& v, 
                unique_associative_container_tag)
  {
    return c.insert(v);
  }
